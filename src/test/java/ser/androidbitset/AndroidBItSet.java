 ...
 */
public class AndroidBItSet implements Serializable {
    ...
    /**
     * Creates a new {@code AndroidBItSet} with size equal to 64 bits.
     */
    public AndroidBItSet() {
        this(new long[1]);
    }

    /**
     * Creates a new {@code AndroidBItSet} with size equal to {@code bitCount}, rounded up to
     * a multiple of 64.
     *
     * @throws NegativeArraySizeException if {@code bitCount < 0}.
     */
    public AndroidBItSet(int bitCount) {
        if (bitCount < 0) {
    ...
    private AndroidBItSet(long[] bits) {
        this.bits = bits;
    ...
    @Override public Object clone() {
        try {
            AndroidBItSet clone = (AndroidBItSet) super.clone();
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof AndroidBItSet)) {
            return false;
        }
        AndroidBItSet lhs = (AndroidBItSet) o;
    ...
    public AndroidBItSet get(int fromIndex, int toIndex) {
        ...
        return new AndroidBItSet(newBits);
    }
    ...
    /**
     * Clears all the bits in this {@code AndroidBItSet}. This method does not change the capacity.
     * Use {@code clear} if you want to reuse this {@code AndroidBItSet} with the same capacity, but
     * create a new {@code AndroidBItSet} if you're trying to potentially reclaim memory.
     */
    public void clear() {
     ...
     */
    public boolean intersects(AndroidBItSet bs) {
        long[] bsBits = bs.bits;
    ...
    /**
     * Logically ands the bits of this {@code AndroidBItSet} with {@code bs}.
     */
    public void and(AndroidBItSet bs) {
    ...
    /**
     * Clears all bits in this {@code AndroidBItSet} which are also set in {@code bs}.
     */
    public void andNot(AndroidBItSet bs) {
        int minSize = Math.min(this.longCount, bs.longCount);
        for (int i = 0; i < minSize; ++i) {
            bits[i] &= ~bs.bits[i];
        }
    ...
    /**
     * Logically ors the bits of this {@code AndroidBItSet} with {@code bs}.
     */
    public void or(AndroidBItSet bs) {
        int minSize = Math.min(this.longCount, bs.longCount);
    ...
    /**
     * Logically xors the bits of this {@code AndroidBItSet} with {@code bs}.
     */
    public void xor(AndroidBItSet bs) {
        int minSize = Math.min(this.longCount, bs.longCount);
        int maxSize = Math.max(this.longCount, bs.longCount);
        ensureCapacity(maxSize);
        for (int i = 0; i < minSize; ++i) {
    ...
    /**
     * Returns the capacity in bits of the array implementing this {@code AndroidBItSet}. This is
     * unrelated to the length of the {@code AndroidBItSet}, and not generally useful.
     ...
     * the {@link #size} of the {@code AndroidBItSet}.
     */
    public int length() {
        if (longCount == 0) {
            return 0;
    ...
    @Override public String toString() {
        //System.err.println("AndroidBItSet[longCount=" + longCount + ",bits=" + Arrays.toString(bits) + "]");
    ...
    /**
     * Returns true if all the bits in this {@code AndroidBItSet} are set to false, false otherwise.
     */
    ...
    /**
     * Returns the number of bits that are {@code true} in this {@code AndroidBItSet}.
     */
    ...
    /**
     * Equivalent to {@code AndroidBItSet.valueOf(LongBuffer.wrap(longs))}, but likely to be faster.
     * This is likely to be the fastest way to create a {@code AndroidBItSet} because it's closest
     * to the internal representation.
     * @since 1.7
     */
    public static AndroidBItSet valueOf(long[] longs) {
        return new AndroidBItSet(longs.clone());
    }

    /**
     * Returns a {@code AndroidBItSet} corresponding to {@code longBuffer}, interpreted as a little-endian
     * sequence of bits. This method does not alter the {@code LongBuffer}.
     * @since 1.7
     */
    public static AndroidBItSet valueOf(LongBuffer longBuffer) {
        ...
        return AndroidBItSet.valueOf(longs);
    }

    /**
     * Equivalent to {@code AndroidBItSet.valueOf(ByteBuffer.wrap(bytes))}.
     * @since 1.7
     */
    public static AndroidBItSet valueOf(byte[] bytes) {
        return AndroidBItSet.valueOf(ByteBuffer.wrap(bytes));
    }

    /**
     * Returns a {@code AndroidBItSet} corresponding to {@code byteBuffer}, interpreted as a little-endian
     * sequence of bits. This method does not alter the {@code ByteBuffer}.
     * @since 1.7
     */
    public static AndroidBItSet valueOf(ByteBuffer byteBuffer) {
     ...
     * this {@code AndroidBItSet}, suitable for passing to {@code valueOf} to reconstruct
     * this {@code AndroidBItSet}.
     * @since 1.7
     */
