...
* used in production in the [Eurex Exchange](http://www.eurexchange.com/exchange-en/) trading back end's middleware
* [JUptr.io](http://blog.juptr.io/){:target="_blank"}'s distributed system / NLP engine uses FST
